...
a| [[quarkus-github-app_quarkus-github-app-organizations]] [.property-path]##link:#quarkus-github-app_quarkus-github-app-organizations[`+++quarkus.github-app.organizations+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.github-app.organizations+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_GITHUB_APP_ORGANIZATIONS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_GITHUB_APP_ORGANIZATIONS+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|
...
h|[[quarkus-github-app_section_quarkus-github-app-telemetry]] [.section-name.section-level0]##link:#quarkus-github-app_section_quarkus-github-app-telemetry[Telemetry configuration]##
h|Type
h|Default
...
a| [[quarkus-github-app_quarkus-github-app-telemetry-record-command]] [.property-path]##link:#quarkus-github-app_quarkus-github-app-telemetry-record-command[`+++quarkus.github-app.telemetry.record-command+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.github-app.telemetry.record-command+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_GITHUB_APP_TELEMETRY_RECORD_COMMAND+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_GITHUB_APP_TELEMETRY_RECORD_COMMAND+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
